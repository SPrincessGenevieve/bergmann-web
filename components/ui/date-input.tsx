...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex rounded-lg items-center text-sm">
      <input
        type="text"
        ref={monthRef}
        max={12}
        ...
        className="text-muted-foreground p-0 outline-none w-5  border-none text-center"
        placeholder="M"
      />
      ...
      <input
        ...
        className="text-muted-foreground p-0 outline-none w-12 border-none text-center"
        placeholder="YYYY"
      />
    </div>
  );
